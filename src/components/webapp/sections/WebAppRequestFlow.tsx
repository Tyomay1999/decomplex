...
export default function WebAppRequestFlow(): JSX.Element {
  const t = useTranslations("webApp.requestFlow");
      ...
      <div className="dc-panel p-8">
        <div className="flow-diagram-horizontal flex items-center gap-4">
          <div className="diagram-box px-6">
            <span className="text-slate-700 dark:text-slate-200">{t("nodes.webApp")}</span>
          </div>
          <Arrow />
          <div className="diagram-box px-6">
        ...
        <div className="flow-diagram-vertical">
          <div className="diagram-box">{t("nodes.webApp")}</div>
          <DownArrow />
